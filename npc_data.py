...
Contains dialogue strings for Old Weary (Migo) and Messy Goblin (Bazzitha).
...
# ═══════════════════════════════════════════════════════════════════════════
# SIR BRAMBLE THE KNIGHT
# ═══════════════════════════════════════════════════════════════════════════

SIR_BRAMBLE_GREETING = (
    '"Halt!" cries a knight in dented silver armor, planting his spear with great ceremony.\n'
    "His crimson plume droops a little, but he lifts his chin as if awaiting applause.\n\n"
    '"You stand before Sir Bramble the Bold, defender of these halls and future legend of this age."\n'
    "He places a hand on his breastplate.\n"
    '"Show proper respect, traveler, and perhaps I shall permit you to continue."'
)

SIR_BRAMBLE_DESCRIPTION = (
    "Sir Bramble is a proud knight who desperately wants to be seen as heroic.\n"
    "His armor is polished in odd places and badly dented in others.\n"
    "He speaks grandly, stands dramatically, and watches closely for admiration."
)

SIR_BRAMBLE_CRUEL_ACTIONS: dict[str, list[str]] = {
    "anger": [
        'You snort and say, "Legendary? You look like you lost a duel with a soup pot."',
    ],
    "sadness": [
        'You ask quietly, "Has anyone ever actually sung songs about you, Sir Bramble?"',
    ],
    "fear": [
        'You step closer and say coldly, "Move aside, knight, before I test that armor myself."',
    ],
    "disgust": [
        'You wrinkle your nose and say, "That plume smells damp. Have you been sleeping in that helmet?"',
    ],
}

SIR_BRAMBLE_KIND_ACTIONS: dict[str, list[str]] = {
    "happy": [
        'You smile and say, "That was quite an introduction. You certainly know how to make an entrance."',
    ],
    "peaceful": [
        'You nod and say, "This corridor does feel safer with a watchful knight standing here."',
    ],
    "platonic_love": [
        'You say, "Every stronghold needs someone loyal. I think your heart is in the right place."',
    ],
    "romantic_attraction": [
        'You tilt your head and say, "A dramatic knight in shining armor? That is surprisingly charming."',
    ],
}

SIR_BRAMBLE_CRUEL_REACTIONS: dict[tuple[str, int], str] = {

    ("anger", 1): (
        "Sir Bramble stiffens. His jaw tightens and his grip on the spear hardens.\n"
        '"Mock me if you like," he snaps, "but greatness is often misunderstood at first."'
    ),

    ("anger", 2): (
        "His face reddens beneath the helmet strap. He draws himself up and trembles with outrage.\n"
        '"You dare insult ME? I have trained, suffered, and SACRIFICED for glory!"'
    ),

    ("anger", 3): (
        "Sir Bramble erupts. He tears off his plume, throws it to the floor,\n"
        "and stamps on it in pure humiliation.\n"
        '"Enough! I will not stand here and be mocked by the likes of you!"\n'
        "He storms away in a clatter of armor, muttering about fools who cannot recognize greatness.\n\n"
        "Sir Bramble explodes in ANGER and leaves the corridor."
    ),

    ("sadness", 1): (
        "His proud expression flickers.\n"
        '"Songs take time," he says too quickly. "Not every hero is appreciated right away."'
    ),

    ("sadness", 2): (
        "His shoulders droop despite himself. The spear lowers a little.\n"
        '"I thought... perhaps by now there would be stories," he says quietly.'
    ),

    ("sadness", 3): (
        "All grandeur leaves him. He stares at the floor in silence.\n"
        '"Perhaps I was never meant to be remembered," he whispers.\n'
        "He gathers what remains of his dignity and walks away slowly.\n\n"
        "Sir Bramble leaves in SADNESS."
    ),

    ("fear", 1): (
        "Sir Bramble takes half a step back before catching himself.\n"
        '"Now let\'s not be rash," he says, trying to sound commanding.'
    ),

    ("fear", 2): (
        "His confidence begins to crack. His eyes dart toward the corridor behind him.\n"
        '"A wise knight knows when restraint is the better part of valor," he says weakly.'
    ),

    ("fear", 3): (
        "Sir Bramble drops his spear with a clang.\n"
        '"Very well! Take the corridor! Take it!" he blurts, then runs as fast as his armor allows.\n\n'
        "Sir Bramble flees in FEAR."
    ),

    ("disgust", 1): (
        'Sir Bramble grimaces and brushes at his armor. "That is deeply uncalled for," he mutters.'
    ),

    ("disgust", 2): (
        "He looks genuinely offended now, tugging at his plume with visible discomfort.\n"
        '"There is such a thing as knightly dignity," he says through clenched teeth.'
    ),

    ("disgust", 3): (
        "Sir Bramble gags at the insult to his carefully maintained image.\n"
        "With a shudder of offended pride, he retreats down the corridor.\n\n"
        "Sir Bramble leaves in DISGUST."
    ),
}

SIR_BRAMBLE_KIND_REACTIONS: dict[tuple[str, int], str] = {

    ("happy", 1): (
        "Sir Bramble brightens at once.\n"
        '"At last! Someone with an eye for quality," he says, standing taller.'
    ),

    ("happy", 2): (
        "He beams openly now, basking in your approval.\n"
        '"I knew it," he says. "True greatness cannot be hidden forever."'
    ),

    ("happy", 3): (
        "Sir Bramble is radiant with smug delight. He strikes a pose as if carved for a statue.\n"
        '"Yes. YES. This is how a knight ought to be received!" he declares.\n'
        "He refuses to leave his post, too pleased with himself to move.\n\n"
        "Sir Bramble feels so HAPPY he vows to remain here forever.\n"
        "ESCAPE IS NOW IMPOSSIBLE."
    ),

    ("peaceful", 1): (
        "Some of the strain leaves his face.\n"
        '"It is... good to be acknowledged," he says more softly.'
    ),

    ("peaceful", 2): (
        "Sir Bramble rests both hands on the pommel of his spear and exhales.\n"
        '"Perhaps I do not need applause every moment," he admits.'
    ),

    ("peaceful", 3): (
        "Sir Bramble becomes serenely content in his role.\n"
        '"This hall, this watch, this purpose — yes. This is enough for me," he says.\n'
        "He settles in with complete satisfaction and will not budge.\n\n"
        "Sir Bramble feels so PEACEFUL he stays forever.\n"
        "ESCAPE IS NOW IMPOSSIBLE."
    ),

    ("platonic_love", 1): (
        "Sir Bramble looks genuinely touched.\n"
        '"You speak as a friend would," he says, surprised.'
    ),

    ("platonic_love", 2): (
        "His voice softens beneath the armor and bravado.\n"
        '"Loyalty... yes. That matters more than songs, perhaps," he says.'
    ),

    ("platonic_love", 3): (
        "Sir Bramble clasps your forearm with intense sincerity.\n"
        '"At last — a true companion who understands honor!" he cries.\n'
        "He becomes so devoted to this bond that he refuses to abandon the spot.\n\n"
        "Sir Bramble is overwhelmed with FRIENDSHIP and stays forever.\n"
        "ESCAPE IS NOW IMPOSSIBLE."
    ),

    ("romantic_attraction", 1): (
        "Sir Bramble blinks behind his heroic expression.\n"
        '"Charming?" he repeats, trying and failing not to smile.'
    ),

    ("romantic_attraction", 2): (
        "He smooths his plume and straightens his breastplate.\n"
        '"Well... a knight must maintain standards," he says, suddenly very aware of himself.'
    ),

    ("romantic_attraction", 3): (
        "Sir Bramble is completely undone by the attention.\n"
        '"Then let this place be remembered as the hall where destiny — and admiration — found me," he says dreamily.\n'
        "He plants himself in the corridor forever, basking in the moment.\n\n"
        "Sir Bramble feels so much ROMANTIC ATTRACTION that he stays forever.\n"
        "ESCAPE IS NOW IMPOSSIBLE."
    ),
}

# ═══════════════════════════════════════════════════════════════════════════
# LILA THE LONELY CHILD
# ═══════════════════════════════════════════════════════════════════════════

LILA_GREETING = (
    "A small child sits on the cold stone floor, hugging her knees.\n"
    "She looks up at you with wide uncertain eyes.\n\n"
    '"Oh… hello," she says quietly. "I did not think anyone would come here."'
)

LILA_DESCRIPTION = (
    "Lila is a small child with messy hair and large expressive eyes.\n"
    "Her oversized cloak pools around her feet. She seems lonely but hopeful."
)

LILA_CRUEL_ACTIONS: dict[str, list[str]] = {
    "anger": [
        'You snap, "Stop staring at me like that."',
    ],
    "sadness": [
        'You say, "No one is coming for you, you know."',
    ],
    "fear": [
        'You loom over her and whisper, "This dungeon is not safe for children."',
    ],
    "disgust": [
        'You wrinkle your nose and say, "You look filthy."',
    ],
}

LILA_KIND_ACTIONS: dict[str, list[str]] = {
    "happy": [
        'You smile and say, "Hello Lila. It is nice to meet you."',
    ],
    "peaceful": [
        'You sit beside her quietly so she is not alone.',
    ],
    "platonic_love": [
        'You say, "You seem brave for someone so small."',
    ],
    "romantic_attraction": [
        'You gently say, "You have a very kind smile."',
    ],
}

LILA_CRUEL_REACTIONS: dict[tuple[str, int], str] = {

    ("anger", 1): (
        "Lila frowns and looks away.\n"
        '"That was not nice."'
    ),
    ...
    ("anger", 3): (
        "Lila jumps to her feet, furious and trembling.\n"
        '"Fine! I do not want to talk to you anyway!"\n\n'
        "Lila storms off in ANGER."
    ),

    ("sadness", 1): (
        "Lila looks down at the floor.\n"
        '"Oh…"'
    ),
    ...
    ("sadness", 3): (
        "Lila begins to cry and runs away down the corridor.\n\n"
        "Lila leaves in SADNESS."
    ),

    ("fear", 1): (
        "Lila shrinks back slightly.\n"
        '"Please do not scare me."'
    ),

    ("fear", 2): (
        "Her hands shake as she steps away.\n"
        '"I want to go home…"'
    ),

    ("fear", 3): (
        "Lila turns and runs as fast as she can.\n\n"
        "Lila flees in FEAR."
    ),

    ("disgust", 1): (
        "Lila wipes her sleeve nervously.\n"
    ...
    ("disgust", 3): (
        "Lila covers her face and runs away.\n\n"
        "Lila leaves in DISGUST."
    ),
}

LILA_KIND_REACTIONS: dict[tuple[str, int], str] = {

    ("happy", 1): (
        "Lila smiles a little.\n"
        '"You seem nice."'
    ),
    ...
    ("happy", 3): (
        ...
        "Lila feels so HAPPY she stays here to talk with you."
    ),

    ("peaceful", 1): (
        "Lila relaxes slightly beside you."
    ),

    ("peaceful", 2): (
        "She leans against the wall calmly."
    ),

    ("peaceful", 3): (
        "Lila closes her eyes peacefully.\n\n"
        "Lila feels safe and stays here peacefully."
    ),
    ...
    ("platonic_love", 3): (
        "Lila hugs you tightly.\n\n"
        "Lila feels strong FRIENDSHIP and stays happily."
    ),
    ...
    ("romantic_attraction", 3): (
        "Lila looks delighted.\n\n"
        "Lila stays nearby, completely charmed."
    ),
}
...
TORREN_GREETING = (
    "A young guard stands rigidly beside the corridor wall.\n"
    "His spear trembles ever so slightly in his grip.\n\n"
    '"Halt there!" he says quickly. "State your business in this corridor."'
)

TORREN_DESCRIPTION = (
    "Torren is a young guard in slightly oversized armor.\n"
    "He tries to look brave, but his eyes constantly dart toward the shadows."
)

TORREN_CRUEL_ACTIONS: dict[str, list[str]] = {
    "anger": [
        'You scoff and say, "You call yourself a guard?"',
    ],
    "sadness": [
        'You sigh and say, "You look like someone who regrets joining the watch."',
    ],
    "fear": [
        'You lean close and whisper, "Something terrible is coming down this corridor."',
    ],
    "disgust": [
        'You wrinkle your nose and say, "That armor smells terrible."',
    ],
}

TORREN_KIND_ACTIONS: dict[str, list[str]] = {
    "happy": [
        'You smile and say, "You look like a very capable guard."',
    ],
    "peaceful": [
        'You nod calmly and say, "This corridor feels safer with someone watching it."',
    ],
    "platonic_love": [
        'You say, "Standing watch like this takes real courage."',
    ],
    "romantic_attraction": [
        'You say softly, "A brave guard is a reassuring sight."',
    ],
}

TORREN_CRUEL_REACTIONS: dict[tuple[str, int], str] = {

    ("anger", 1): (
        "Torren frowns and tightens his grip on the spear.\n"
        '"That was uncalled for."'
    ),

    ("anger", 2): (
        "His face reddens with frustration.\n"
        '"I am doing my duty!"'
    ),

    ("anger", 3): (
        "Torren slams the spear against the ground.\n"
        '"Fine! Guard it yourself!"\n\n'
        "Torren storms away in ANGER."
    ),

    ("sadness", 1): (
        "Torren looks down at the floor.\n"
        '"Maybe this was a mistake…"'
    ),

    ("sadness", 2): (
        "His shoulders slump.\n"
        '"I thought this job would mean something."'
    ),

    ("sadness", 3): (
        "Torren quietly walks away without another word.\n\n"
        "Torren leaves in SADNESS."
    ),

    ("fear", 1): (
        "Torren stiffens immediately.\n"
        '"W-what do you mean something is coming?"'
    ),

    ("fear", 2): (
        "His hands shake badly now.\n"
        '"I knew this post was cursed…"'
    ),

    ("fear", 3): (
        "Torren drops his spear and runs down the corridor.\n\n"
        "Torren flees in FEAR."
    ),

    ("disgust", 1): (
        "Torren looks embarrassed and brushes his armor.\n"
        '"It\'s not that bad"'
    ),

    ("disgust", 2): (
        "He shifts awkwardly.\n"
        '"I have been on watch a long time."'
    ),

    ("disgust", 3): (
        "Torren turns red with humiliation and walks away quickly.\n\n"
        "Torren leaves in DISGUST."
    ),
}

TORREN_KIND_REACTIONS: dict[tuple[str, int], str] = {

    ("happy", 1): (
        "Torren smiles slightly.\n"
        '"Thank you."'
    ),
    ...
    ("happy", 3): (
        "Torren beams with pride.\n\n"
        "Torren feels so HAPPY he remains proudly at his post."
    ),

    ("peaceful", 1): (
        "Torren relaxes slightly."
    ),

    ("peaceful", 2): (
        "His breathing slows and he steadies his spear."
    ),

    ("peaceful", 3): (
        "Torren stands calmly in the corridor.\n\n"
        "Torren feels peaceful and continues his watch."
    ),

    ("platonic_love", 1): (
        "Torren nods gratefully.\n"
        '"That means a lot."'
    ),
    ...
    ("platonic_love", 3): (
        "Torren clasps your arm warmly.\n\n"
        "Torren feels strong FRIENDSHIP and stays at his post."
    ),

    ("romantic_attraction", 1): (
        "Torren blushes slightly."
    ),

    ("romantic_attraction", 2): (
        "He looks flattered and slightly nervous."
    ),

    ("romantic_attraction", 3): (
        "Torren smiles proudly.\n\n"
        "Torren remains nearby, clearly pleased."
    ),
}
# ═══════════════════════════════════════════════════════════════════════════
# GRUN THE GIANT
...
GRUN_GREETING = (
    "A massive figure blocks the corridor ahead.\n"
    "The giant scratches his head slowly and looks down at you.\n\n"
    '"Oh... hello little person," he rumbles. "Grun standing here because someone told Grun to guard hallway."'
)

GRUN_DESCRIPTION = (
    "Grun is a towering giant with rough clothes and enormous hands.\n"
    "Despite his size, his eyes look gentle and a little confused."
)

GRUN_CRUEL_ACTIONS: dict[str, list[str]] = {
    "anger": [
        'You snap, "Move out of the way, you oversized fool."',
    ],
    "sadness": [
        'You sigh and say, "You are not very smart, are you?"',
    ],
    "fear": [
        'You glare and whisper, "I have defeated giants bigger than you."',
    ],
    "disgust": [
        'You wrinkle your nose and say, "You smell terrible."',
    ],
}

GRUN_KIND_ACTIONS: dict[str, list[str]] = {
    "happy": [
        'You smile and say, "Hello Grun. It is nice to meet you."',
    ],
    "peaceful": [
        'You sit calmly nearby so Grun does not feel alone.',
    ],
    "platonic_love": [
        'You say, "You seem like a good friend to have."',
    ],
    "romantic_attraction": [
        'You laugh and say, "A giant with a gentle heart is very charming."',
    ],
}

GRUN_CRUEL_REACTIONS: dict[tuple[str, int], str] = {
    ...
    ("anger", 2): (
        "Grun's enormous fists clench.\n"
        '"Grun trying to be polite."'
    ),

    ("anger", 3): (
        "Grun stomps the ground with a thunderous boom.\n"
        '"Fine! Grun leaving!"\n\n'
        "Grun storms away in ANGER."
    ),

    ("sadness", 1): (
        "Grun looks down sadly.\n"
        '"Grun trying best…"'
    ),

    ("sadness", 2): (
        "His shoulders droop.\n"
        '"Maybe Grun not good guard…"'
    ),

    ("sadness", 3): (
        "Grun turns slowly and walks away.\n\n"
        "Grun leaves in SADNESS."
    ),

    ("fear", 1): (
        "Grun steps back slightly.\n"
        '"You sound scary…"'
    ),

    ("fear", 2): (
        "Grun looks around nervously.\n"
        '"Maybe hallway dangerous…"'
    ),

    ("fear", 3): (
        "Grun runs down the corridor with heavy footsteps.\n\n"
        "Grun flees in FEAR."
    ),
    ...
    ("disgust", 2): (
        "Grun looks embarrassed.\n"
        '"Maybe Grun smell little."'
    ),

    ("disgust", 3): (
        "Grun looks deeply ashamed and shuffles away.\n\n"
        "Grun leaves in DISGUST."
    ),
}

GRUN_KIND_REACTIONS: dict[tuple[str, int], str] = {
    ...
    ("happy", 2): (
        "Grun laughs warmly.\n"
        '"Grun like talking to you."'
    ),

    ("happy", 3): (
        "Grun beams with joy.\n\n"
        "Grun feels so HAPPY he happily stays here."
    ),

    ("peaceful", 1): (
        "Grun relaxes slightly."
    ),

    ("peaceful", 2): (
        "Grun sits on the floor comfortably."
    ),

    ("peaceful", 3): (
        "Grun closes his eyes calmly.\n\n"
        "Grun feels peaceful and remains here."
    ),
    ...
    ("platonic_love", 2): (
        "Grun offers a huge handshake."
    ),

    ("platonic_love", 3): (
        "Grun lifts you in a joyful hug.\n\n"
        "Grun feels strong FRIENDSHIP and stays nearby."
    ),

    ("romantic_attraction", 1): (
        "Grun blushes slightly."
    ),

    ("romantic_attraction", 2): (
        "Grun looks very pleased."
    ),

    ("romantic_attraction", 3): (
        "Grun smiles dreamily.\n\n"
        "Grun remains nearby, clearly delighted."
    ),
}

# Canonical export names used by game_state/NPC registry.
GIANT_GREETING = GRUN_GREETING
GIANT_DESCRIPTION = GRUN_DESCRIPTION
GIANT_CRUEL_ACTIONS = GRUN_CRUEL_ACTIONS
GIANT_KIND_ACTIONS = GRUN_KIND_ACTIONS
GIANT_CRUEL_REACTIONS = GRUN_CRUEL_REACTIONS
GIANT_KIND_REACTIONS = GRUN_KIND_REACTIONS

KNIGHT_GREETING = SIR_BRAMBLE_GREETING
KNIGHT_DESCRIPTION = SIR_BRAMBLE_DESCRIPTION
KNIGHT_CRUEL_ACTIONS = SIR_BRAMBLE_CRUEL_ACTIONS
KNIGHT_KIND_ACTIONS = SIR_BRAMBLE_KIND_ACTIONS
KNIGHT_CRUEL_REACTIONS = SIR_BRAMBLE_CRUEL_REACTIONS
KNIGHT_KIND_REACTIONS = SIR_BRAMBLE_KIND_REACTIONS
...
VARGO_GREETING = (
    "A neatly dressed merchant stands behind a small folding table covered in odds and ends.\n"
    "He smiles the instant he sees you, though his eyes flick immediately to your pockets.\n\n"
    '"Ah! A customer — or at least someone who could become one," he says smoothly.\n'
    '"Welcome, welcome. I am Vargo, trader of rare goods, fair prices, and excellent judgment."'
)

VARGO_DESCRIPTION = (
    "Vargo is a shrewd traveling merchant with a polished smile and watchful eyes.\n"
    "He keeps one hand near his coin purse and the other near whatever might be profitable."
)

VARGO_CRUEL_ACTIONS: dict[str, list[str]] = {
    "anger": [
        'You scoff and say, "You are not clever. You are just greedy."',
    ],
    "sadness": [
        'You glance at his little stall and say, "This is all your grand success amounts to?"',
    ],
    "fear": [
        'You lean in and whisper, "If your deals go wrong, merchants disappear in places like this."',
    ],
    "disgust": [
        'You wrinkle your nose and say, "These goods look cheap, dusty, and handled by too many hands."',
    ],
}

VARGO_KIND_ACTIONS: dict[str, list[str]] = {
    "happy": [
        'You smile and say, "You clearly know how to spot opportunity."',
    ],
    "peaceful": [
        'You nod calmly and say, "There is something reassuring about a skilled trader who keeps things orderly."',
    ],
    "platonic_love": [
        'You say, "A good merchant keeps people supplied. That matters more than most admit."',
    ],
    "romantic_attraction": [
        'You tilt your head and say, "Confidence and sharp eyes can be very attractive in a man."',
    ],
}

VARGO_CRUEL_REACTIONS: dict[tuple[str, int], str] = {

    ("anger", 1): (
        "Vargo's smile tightens at the edges.\n"
        '"There is no need to be rude when business could still be done."'
    ),

    ("anger", 2): (
        "His eyes narrow and his voice loses its smooth warmth.\n"
        '"Greedy? That is a word used by people who do not understand value."'
    ),

    ("anger", 3): (
        "Vargo slams his ledger shut and sweeps several items off the table in outrage.\n"
        '"Enough! I will not stand here and be insulted by someone with no head for trade!"\n\n'
        "Vargo storms away in ANGER."
    ),

    ("sadness", 1): (
        "Vargo glances down at his wares for just a moment.\n"
        '"Everyone starts somewhere," he says quietly.'
    ),

    ("sadness", 2): (
        "His polished confidence falters.\n"
        '"I had larger plans than this, once," he admits.'
    ),

    ("sadness", 3): (
        "Vargo gathers his things slowly, no longer meeting your eyes.\n\n"
        "Vargo leaves in SADNESS."
    ),

    ("fear", 1): (
        "Vargo swallows and forces a weak smile.\n"
        '"Now, now. Let us not make this personal."'
    ),

    ("fear", 2): (
        "His hands move quickly to gather his coin purse and ledger.\n"
        '"A prudent merchant knows when a deal has become unsafe."'
    ),

    ("fear", 3): (
        "Vargo snatches up his money and flees down the corridor without another word.\n\n"
        "Vargo flees in FEAR."
    ),

    ("disgust", 1): (
        "Vargo brushes dust from the nearest item, looking offended.\n"
        '"These are curated goods, not junk."'
    ),

    ("disgust", 2): (
        "His lip curls in wounded pride.\n"
        '"You have a very untrained eye, clearly."'
    ),

    ("disgust", 3): (
        "Vargo recoils from your scorn as though it were a stain on his reputation.\n\n"
        "Vargo leaves in DISGUST."
    ),
}

VARGO_KIND_REACTIONS: dict[tuple[str, int], str] = {

    ("happy", 1): (
        "Vargo's smile becomes genuine for the first time.\n"
        '"Ah. At last, someone who appreciates talent."'
    ),

    ("happy", 2): (
        "He straightens proudly and taps his ledger with satisfaction.\n"
        '"Yes, exactly. Opportunity is wasted on most people, but not on me."'
    ),

    ("happy", 3): (
        "Vargo beams with delighted self-importance.\n"
        '"You understand me perfectly," he says. "A rare gift in itself."\n\n'
        "Vargo feels so HAPPY he becomes openly friendly and eager to impress."
    ),

    ("peaceful", 1): (
        "Vargo relaxes slightly, his tone becoming less sharp."
    ),

    ("peaceful", 2): (
        "He arranges the goods on his table with calm, practiced precision.\n"
        '"Order makes trade possible," he says softly.'
    ),

    ("peaceful", 3): (
        "Vargo folds his hands and looks entirely at ease.\n\n"
        "Vargo feels peaceful and remains here in quiet confidence."
    ),

    ("platonic_love", 1): (
        "Vargo looks pleasantly surprised.\n"
        '"That is more respect than most traders ever receive."'
    ),

    ("platonic_love", 2): (
        "He nods warmly, his guard lowered a little.\n"
        '"You may actually be worth doing honest business with."'
    ),

    ("platonic_love", 3): (
        "Vargo clasps your forearm with sudden sincerity.\n\n"
        "Vargo feels strong FRIENDSHIP and treats you like a trusted associate."
    ),

    ("romantic_attraction", 1): (
        "Vargo blinks, then smooths his sleeves with obvious pleasure."
    ),

    ("romantic_attraction", 2): (
        "He smiles with renewed confidence, clearly enjoying your attention."
    ),

    ("romantic_attraction", 3): (
        "Vargo looks utterly delighted, posture perfect, grin dazzling.\n\n"
        "Vargo remains nearby, clearly charmed and eager to impress you."
    ),
}
